...
public class DbManga : DbObject
{
    ...
    [JsonPropertyName("displayTitle"), Column("display_title", ExcludeUpdates = true)]
    public string? DisplayTitle { get; set; }

    [JsonPropertyName("ordinalVolumeReset"), Column("ordinal_volume_reset", ExcludeUpdates = true)]
