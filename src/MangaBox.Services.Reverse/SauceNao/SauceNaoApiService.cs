namespace MangaBox.Services.Reverse.SauceNao;
...
public class SauceNaoApiService : ISauceNaoApiService
{
    ...
    public string ApiKey => _config["Reverse:SauceNaoToken"] ?? throw new NullReferenceException("Reverse:SauceNaoToken Config is null");
